    ...
    _AX6UIFormatter2.default.setFormatter({
      "myPattern": {
        getEnterableKeyCodes: function getEnterableKeyCodes(_opts) {
          ...
          return jQuery.extend(enterableKeyCodes, _AX6UIFormatter2.default.getCtrlKeys(), _AX6UIFormatter2.default.getNumKeys());
        },
