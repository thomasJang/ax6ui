...
require("./AX6UIDialog/index.scss");
...
var open = function open(opts, callback) {
    ...
    this.activeDialog = (0, _jqmin2.default)('#' + opts.id);
    ...
    (0, _jqmin2.default)(window).on("resize.ax6dialog", throttledResize.bind(this));
    ...
    _createClass(AX6UIDialog, [{
        ...
        value: function close(_option) {
            ...
            if (this.activeDialog) {
                ...
                (0, _jqmin2.default)(window).off("keydown.ax6dialog");
                (0, _jqmin2.default)(window).off("resize.ax6dialog");
