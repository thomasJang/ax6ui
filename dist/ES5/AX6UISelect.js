    ...
    _createClass(AX6UISelect, [{
        ...
        value: function open(boundID, tryCount) {
            var onExpand = function onExpand(item) {
                ...
                item.onExpand.call({
                    ...
                    if (_this4.waitOptionsCallback) {
                        var data = {};
                        var item = _this4.queue[_this4.activeSelectQueueIndex];
                        ...
                        item.$displayLabel.html(getLabel.call(_this4, _this4.activeSelectQueueIndex));
                        item.options = syncSelectOptions.call(_this4, _this4.activeSelectQueueIndex, O.options);
                        ...
                        _this4.activeSelectOptionGroup.find('[data-els="content"]').html(_AX6Mustache2.default.render(optionsTmpl.call(_this4, item.columnKeys), data));
                    }
                });
            };
            ...
            setTimeout(function () {
                ...
                (0, _jqmin2.default)(window).on("keyup.ax6select-" + this.instanceId, function (e) {
                    e = e || window.event;
                    onBodyKeyup.call(this, e);
                    _AX6Util2.default.stopEvent(e);
                }.bind(this));

                (0, _jqmin2.default)(window).on("click.ax6select-" + this.instanceId, function (e) {
                    e = e || window.event;
                ...
                'arr': function arr(queIdx, values, selected) {
                    ...
                    values.forEach(function (value) {
                        if (_AX6Util2.default.isString(value) || _AX6Util2.default.isNumber(value)) {
                            processor.value.call(_this5, queIdx, value, selected);
                        } else {
                            for (var _key in processor) {
                                if (value[_key]) {
                                    processor[_key].call(_this5, queIdx, value, selected);
                                    break;
                                }
                            }
                        }
        ...
        value: function close(item) {
            ...
            this.closeTimer = setTimeout(function () {
                if (_this6.activeSelectOptionGroup) _this6.activeSelectOptionGroup.remove();
                _this6.activeSelectOptionGroup = null;
                _this6.activeSelectQueueIndex = -1;
                ...
                onStateChanged.call(_this6, item, that);
