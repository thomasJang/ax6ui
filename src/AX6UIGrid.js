...
class AX6UIGrid extends AX6UICore {
    ...
    init() {
        ...
        if (typeof this.config.target !== "undefined") {
            ...
            jQuery(window)
                .on("resize.ax6grid-" + this.id, function () {
                    alignGrid.call(self);
                    SCROLLER.resize.call(self);
                    BODY.repaint.call(self);  // window resize시 repaint 함수 호출
                })
                .on("keydown.ax6grid-" + this.instanceId, function (e) {
                    if (self.focused) {
            ...
            jQuery(document.body).on("click.ax6grid-" + this.id, (function (e) {
