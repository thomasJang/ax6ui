    ...
    alert(opts, callback, tryCount) {
        ...
        if (this.activeDialog) {
            ...
            if (!tryCount) {
                ...
                }, Number(this.config.animateTime) + 100);
            } else {
                console.log(info.getError("ax6dialog", "501", "alert"));
            }
            return this;
        }

        this.dialogConfig = opts = jQuery.extend(true, {}, this.config, opts);
    ...
    confirm(opts, callback, tryCount) {
        ...
        if (this.activeDialog) {
            ...
            if (!tryCount) {
                ...
                }).bind(this), Number(this.config.animateTime) + 100);
            } else {
                console.log(info.getError("ax6dialog", "501", "confirm"));
            }
            return this;
        }
    ...
    prompt(opts, callback, tryCount) {
        ...
        if (this.activeDialog) {
            ...
            if (!tryCount) {
                ...
                console.log(info.getError("ax6dialog", "501", "prompt"));
            }
            return this;
        }
