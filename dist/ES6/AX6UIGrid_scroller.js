...
const scrollBarMover = {
    ...
    "on": function (track, bar, type, e) {
        ...
        jQuery(document.body).on(UTIL.ENM["mousemove"] + ".ax6grid-" + this.instanceId, function (e) {
    ...
    "off": function () {
        ...
        jQuery(document.body).off(UTIL.ENM["mousemove"] + ".ax6grid-" + this.instanceId).off(UTIL.ENM["mouseup"] + ".ax6grid-" + this.instanceId).off("mouseleave.ax6grid-" + this.instanceId);
...
const scrollContentMover = {
    ...
    "on": function () {
        ...
        jQuery(document.body).on("touchmove" + ".ax6grid-" + this.instanceId, function (e) {
    ...
    "off": function () {
        ...
        jQuery(document.body).off("touchmove" + ".ax6grid-" + this.instanceId).off("touchend" + ".ax6grid-" + this.instanceId);
...
const init = function () {
    ...
    this.$["scroller"]["vertical-bar"].on(UTIL.ENM["mousedown"], function (e) {
    ...
    this.$["scroller"]["horizontal-bar"].on(UTIL.ENM["mousedown"], function (e) {
        this.xvar.mousePosition = UTIL.getMousePosition(e);
